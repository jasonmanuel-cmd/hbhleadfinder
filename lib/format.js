export const EVENT_LABELS = {
  ...
  death_joint_tenant: 'Death — Joint Tenant',
  tod_affidavit: 'Death — TOD Transfer',
  tax_lien: 'Tax Lien',
  judgment_lien: 'Judgment',
};
...
export const DEATH_SIGNALS = ['death_joint_tenant', 'tod_affidavit', 'letters_testamentary', 'probate_opened'];
export const CHANNELS = ['call', 'sms', 'email', 'letter', 'door', 'referral', 'other'];
export const OUTREACH_STATUS = ['sent', 'attempted', 'reached', 'voicemail', 'no_answer', 'wrong_contact', 'bad_number',
